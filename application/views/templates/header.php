...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?= base_url(); ?>assets/css/jquery-ui.css" rel="stylesheet" type="text/css" id="app-stylesheet" />
            ...
            <div class="navbar-custom">
                ...
                <div class="logo-box">
                    <a href="<?= base_url(); ?>" class="logo text-center logo-dark">
                        <span class="logo-lg">
                            <img src="<?= base_url(); ?>assets/images/logo-cms.png" alt="" height="50">
                            <!-- <span class="logo-lg-text-dark">Velonic</span> -->
                        </span>
                        <span class="logo-sm">
                            <!-- <span class="logo-lg-text-dark">V</span> -->
                            <img src="<?= base_url(); ?>assets/images/logo-cms.png" alt="" height="22">
                        </span>
                    </a>
